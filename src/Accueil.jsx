...
function Accueil (){
  ...
  <span  className="mx-3">ExpressJs</span>
    ...
    <FontAwesomeIcon icon={faSearch} className='text-gray-400 px-2 text-lg'/>
      ...
      <h3 className="underline text-xl font-bold text-gray-200">Sait pas par ou commencer?</h3>
       </div>
...
<h3 className="p-4 w-64  bg-green-200 -z-10 -mt-24" id="myborder"></h3>
     ...
     <div>
     <button className=" bg-blue-400 mx-4 text-white font-bold text-xl py-2 px-6 rounded-2xl my-2">Apprendre HTML</button>
      ...
      <div className="orimadji">
    <div>
    <button className=" bg-blue-400 mx-4 text-white font-bold text-xl py-2 px-7 rounded-2xl my-2">Apprendre CSS3</button>
       ...
       <div className="orimadji">
      <div>
      <button className=" bg-blue-400 mx-4 text-white font-bold text-xl py-2 px-7 rounded-2xl my-2">Apprendre Python</button>
       <button className=" bg-black mx-4 text-white font-bold text-xl py-2 px-8 rounded-2xl my-2">Python Reference</button>
       <button className=" bg-red-400 mx-4 text-white font-bold text-xl py-2 px-5 rounded-2xl">Obtenir un Certificat</button>
      </div>
       </div>
       </div>
       ...
       <div className="pt-16 bg-yellow-400 text-center pb-16">
